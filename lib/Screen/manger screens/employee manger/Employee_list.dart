                        ...
                        child: (selectedUsersItem == 'age')
                            ? Container(
                                ...
                                child: Container(
                                  ...
                                  labels: age_labels,
                                  onChanged: (value) {
                                    Employer_age_start = (value.start.toInt());
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  deleted_employee_id =
                                                                      users[index]
                                                                          .id
                                                                          .toString();
                                                                  // start deleting eployee image from the server
                                                                  Supabase
                                                                      .initialize(
                                                                    url:
                                                                  ...
                                                                  // end deleting eployee image from the server

                                                                  delete_employee_from_the_table =
                                                                      true;

                                                                  deleted_employee =
                                                                      true;
                                                                  // deleted_employee_id = users[index].id;
                                                                  deleted_employee_id =
                                                                      users[index]
                                                                          .id
                                                                          .toString();
              ...
              child: Container(
                  ...
                  child: IconButton(
                    onPressed: () async {
                      ...
                      department_id_items.clear();
                      shift_items.clear();
                      shift_id_items.clear();
                      for (int i = 0; i < departments.length; i++) {
                        department_items.add(departments[i].name);
                        department_id_items.add(departments[i].id);
                      }
                      for (int i = 0; i < shifts.length; i++) {
                        shift_items.add(shifts[i].name);
                        shift_id_items.add(shifts[i].id);
                      }
                      // ignore: unused_local_variable
                      var image_uploaded_successfuly = false;
                      Navigator.push(
                        context,
                        MaterialPageRoute<void>(
                          builder: (BuildContext context) => AddingEmployee(),
                        ),
                      );
                    },
